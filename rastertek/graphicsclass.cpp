...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_GroundModel->Initialize(m_D3D->GetDevice(), "../Engine/data/floor.txt", L"../Engine/data/stone01.dds");
	if (!result)
	{
	...
	result = m_ProjectionTexture->Initialize(m_D3D->GetDevice(), L"../Engine/data/watson.dds");
	if (!result)
	{
	...
	m_ViewPoint->SetPosition(-2.0f, 3.0f, -2.0f);
